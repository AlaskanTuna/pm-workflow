...
- **Hard timeout** (`timeout <T>`): 10 min for reviews/consults, 20 min for workers. On expiry: kill it, proceed Claude-only, tell the human. A Codex call may **never** block the pipeline indefinitely.
